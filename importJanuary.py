...
raw_expenses = [
    # Format: (date, vendor_name, main_category, sub_category, amount)
...
for entry in raw_expenses:
    date_str, vendor, category, sub_category, amount = entry
    category = category.capitalize().strip() if category else None
    vendor_category_map.setdefault(vendor, category)
...
print("✅ January expenses imported.")
print("📋 Vendor-category associations captured:", vendor_category_map)
